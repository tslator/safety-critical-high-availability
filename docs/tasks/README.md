...
| [T-0023](T-0023-monitor-logical-ring-attribution.md) | Phase 5 | Monitor logical-ring attribution (Phase 4 tail) | AI agent (opencode) | Complete | High | Phase 4 exit | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md) |
| [T-0024](T-0024-abandoned-claim-rule.md) | Phase 5 | Abandoned producer claim rule (Phase 4 tail) | AI agent (opencode) | Complete | High | Phase 4 exit | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md) |
| [T-0025](T-0025-supervisor-stall-recovery.md) | Phase 5 | Supervisor stall recovery | AI agent (opencode) | Complete | High | T-0023 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0026](T-0026-supervisor-double-fault-degraded.md) | Phase 5 | Supervisor double-fault and DEGRADED state | AI agent (opencode) | Complete | High | T-0023, T-0024, T-0025 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0027](T-0027-worker-corruption-hook.md) | Phase 5 | Worker SIGUSR2 memory-corruption hook | AI agent (opencode) | Complete | High | Phase 4 exit | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0028](T-0028-perturb-harness-cli.md) | Phase 5 | Perturbation harness library and CLI | AI agent (opencode) | Complete | High | T-0023, T-0024, T-0025, T-0026, T-0027 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0029](T-0029-compose-perturb-scenarios.md) | Phase 5 | Compose perturb service and scenario scripts | AI agent (opencode) | Complete | High | T-0028 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0030](T-0030-replay-log-deterministic-scenario.md) | Phase 5 | Replay log and deterministic S1 scenario | AI agent (opencode) | Complete | Medium | T-0028, T-0029 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0031](T-0031-phase5-integration-exit.md) | Phase 5 | Integration, evidence, and phase exit | AI agent (opencode) | Complete | High | T-0023, T-0024, T-0025, T-0026, T-0027, T-0028, T-0029, T-0030 | [DEC-0012](../decisions/0012-phase5-perturbation-engine.md), [evidence](../evidence/phase-5.md) |
| [T-0032](T-0032-handoff-stall-blindspot.md) | Phase 5 | Failover handoff visibility and stall bounding (S1-R CI flake) | AI agent (opencode) | Complete | High | T-0025, T-0026, T-0030 | [DEC-0013](../decisions/0013-handoff-visibility-and-stall-bounding.md), [D-2026-09-23-001](../reviews/2026-09-23-s1r-handoff-stall-blindspot.md), [evidence](../evidence/phase-5.md) |
| [T-0033](T-0033-event-log-library.md) | Phase 6 | Sequenced append-only event log library | AI agent (opencode) | Complete | High | Phase 5 exit | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |
| [T-0034](T-0034-structured-logging-migration.md) | Phase 6 | Structured logging migration (supervisor, workers, monitor append) | Unassigned | Planned | High | T-0033 | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |
| [T-0035](T-0035-http-server-core.md) | Phase 6 | Bounded HTTP/1.1 server core | Unassigned | Planned | High | Phase 5 exit | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |
| [T-0036](T-0036-metrics-registry-prometheus.md) | Phase 6 | Metrics registry and Prometheus encoder | Unassigned | Planned | High | T-0033, T-0035 | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |
| [T-0037](T-0037-health-status-endpoints.md) | Phase 6 | Health report and status endpoints | Unassigned | Planned | High | T-0035, T-0036 | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |
| [T-0038](T-0038-observability-cli-compose.md) | Phase 6 | Observability CLI subcommand and Compose service | Unassigned | Planned | High | T-0034, T-0036, T-0037 | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |

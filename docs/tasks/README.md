...
| [T-0009](T-0009-worker-core.md) | Phase 2 | T2.1 — worker core (config, workload, pipeline) | AI agent (opencode) | In Review | High | Phase 1 exit | [DEC-0009](../decisions/0009-phase2-worker-runtime.md), [evidence](../../NOTES.md) |
| [T-0010](T-0010-work-loop-signals-deadlines.md) | Phase 2 | T2.2 — work loop, signals, deadline monitoring | Unassigned | Planned | High | T-0009 | [DEC-0009](../decisions/0009-phase2-worker-runtime.md) |

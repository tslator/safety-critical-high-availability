...
| [T-0006](T-0006-t1.5-stress-and-exit.md) | Phase 1 | T1.5 — stress tests and phase exit | AI agent (opencode) | In Progress | High | T-0004, T-0005 | [Phase 1 plan](../phases/PHASE_1_SHARED_MEMORY.md) |

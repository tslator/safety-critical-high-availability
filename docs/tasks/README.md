...
| [T-0033](T-0033-event-log-library.md) | Phase 6 | Sequenced append-only event log library | Unassigned | Planned | High | Phase 5 exit | [DEC-0014](../decisions/0014-phase6-observability-logging.md) |

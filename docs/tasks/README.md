...
| [T-0009](T-0009-worker-core.md) | Phase 2 | T2.1 — worker core (config, workload, pipeline) | Unassigned | Planned | High | Phase 1 exit | [DEC-0009](../decisions/0009-phase2-worker-runtime.md) |

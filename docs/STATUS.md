...
| T1.5: stress tests and Phase 1 exit | Blocked | Soak evidence exists; waiting on T1.4 |

## Next Work

1. Implement T1.4 named shared-memory attach/detach and stale-object rejection.
2. Complete T1.5 exit evidence and update the Phase 1 plan.
